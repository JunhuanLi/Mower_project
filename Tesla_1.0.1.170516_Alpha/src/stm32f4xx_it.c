...
/*------------------------------------------------------------------------------
Function		: USART_DEBUG_HANDLER
Description		: USART_DEBUG_HANDLER
Input			: None
Output			: None
Return			: None
-------------------------------------------------------------------------------*/
void USART_BRODER_HANDLER(void)
{
	u8 res;	
	if(USART_GetITStatus(USART_BRODER,USART_IT_RXNE)!=RESET)
	{
		res = USART_ReceiveData(USART_BRODER);	 
	}  	
...
Return			: None
-------------------------------------------------------------------------------*/
void USART_COM_HANDLER(void)
{
	u8 res;	
	if(USART_GetITStatus(USART_COM,USART_IT_RXNE)!=RESET)
	{
		res = USART_ReceiveData(USART_COM);		
	}  	
