...
#define USART_GPS				    UART8
#define USART_GPS_CLK				RCC_APB1Periph_UART8
#define USART_GPS_IRQ				UART8_IRQn


#define USART_GPS_TX_PORT		    GPIOE
#define USART_GPS_TX_PIN		    GPIO_Pin_1
#define USART_GPS_TX_CLK		    RCC_AHB1Periph_GPIOE
#define USART_GPS_TX_AF		    	GPIO_AF_UART8
#define USART_GPS_TX_SOURCE		    GPIO_PinSource1

#define USART_GPS_RX_PORT		    GPIOE
#define USART_GPS_RX_PIN		    GPIO_Pin_0
#define USART_GPS_RX_CLK		    RCC_AHB1Periph_GPIOE
#define USART_GPS_RX_AF		   		GPIO_AF_UART8
#define USART_GPS_RX_SOURCE		  	GPIO_PinSource0

#define USART_GPS_HANDLER		   	UART8_IRQHandler
